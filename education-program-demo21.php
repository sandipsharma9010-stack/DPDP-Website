...
<body>
            ...
            <div class="row">
                <div class="col-md-6 order-md-1 text-center text-md-start">
                    ...
                    <ol class="list-master">
                        <li>Internship opportunities for <strong>First top 100 scorers</strong></li>
                        <li>Industry <strong>certification</strong></li>
                        <li>DPDP Act Guidebook</li>
                        <li>Webinar Invitation (First Top 100 Scorers)</li>
                    </ol>
                ...
                <div class="col-md-6 order-md-2 text-center position-relative">
                    ...
                    <iframe style="width:100%; height: 90%;" id="videoFrame"
                        src="https://www.youtube.com/embed/kBJYCQ-49sM" title="YouTube video" allowfullscreen
                        allow="autoplay"></iframe>
                    <!-- <img class="cal-number-img" src="./assets/videos/education-program3.gif" alt="DPDPA Banking"> -->

                    <!-- <video width="720" height="420" autoplay loop muted playsinline>
                        <source src="./assets/videos/education-program3.mp4" type="video/mp4">
    ...
    <section class="newsletters-bg my-2">
        ...
        <div class="container">
            ...
            <div class="row align-items-center my-3">
                ...
                <div id="newsletterCarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <img src="./assets/images/education-pro/T1.png" class="d-block w-100" alt="Slide 1">

                                </div>
                                <div class="col-4">
                                    <img src="./assets/images/education-pro/T2.png" class="d-block w-100" alt="Slide 2">

                                </div>
                                <div class="col-4">

                                    <img src="./assets/images/education-pro/T3.png" class="d-block w-100" alt="Slide 2">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <img src="./assets/images/education-pro/T4.png" class="d-block w-100" alt="Slide 3">

                                </div>
                                <!-- <div class="col-4">
                                        
                                            <img src="./assets/images/education-pro/T4.png" class="d-block w-100"
                                                alt="Slide 4">
                    ...
                    <button class="carousel-control-prev arrow-cls" type="button" data-bs-target="#newsletterCarousel"
                        data-bs-slide="prev">
                        <img src="./assets/images/news-letter-arrow-left.png" alt="Previous" class="custom-icon">
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next arrow-cls" type="button" data-bs-target="#newsletterCarousel"
                        data-bs-slide="next">
    ...
    <!-- Modal 1 -->
    <div class="modal fade" id="videoModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe id="videoIframe" width="100%" height="315"
                        src="https://www.youtube.com/embed/WfNxzyU2jJ0?enablejsapi=1" frameborder="0"
        ...
        <div class="container py-4">
            ...
            <div class="card-box">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7">
                        <h4>Exclusive Webinar Invitations <span style="font-size: 12px;">(top 100 scorers)</span></h4>
                        <ul>
            ...
            <div class="row section-cards g-4 justify-content-center">
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="section-card">
                        ...
                        <h5 class="px-3">Law Professionals</h5>
                        <ul>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="section-card">
                        ...
                        <h5 class="px-3">Business Management Professionals</h5>
                        <ul>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="section-card">
                        ...
                        <h5 class="px-3">Tech Students</h5>
                        <ul>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="section-card">
                        ...
                        <h5 class="px-3">Early Professionals</h5>
                        <ul>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="section-card">
                        ...
                        <h5 class="px-3">Compliance Experts</h5>
                        <ul>
    ...
    <div class="modal fade" id="videoModal2" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="videoModalLabel">HTML5 Video</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        onclick="stopVideo()"></button>
                </div>
                <div class="modal-body p-0">
                    <video style="width:100%; height:300px !important" id="html5Video" class="" controls autoplay>
                        <source src="./assets/images/education-pro/Mohini-Singla-Final-Video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>
    ...
    <div class="modal fade" id="videoModal3" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <video style="width:100%; height:300px !important" id="html5Video" class="" controls autoplay>
                        <source src="./assets/images/education-pro/Anupam-Srivastav-Final-Video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>
    ...
    <div class="modal fade" id="videoModal4" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <video style="width:100%; height:300px !important" id="html5Video" class="" controls autoplay>
                        <source src="./assets/images/education-pro/Aditya-Giri.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>
    ...
    <div class="modal fade" id="videoModal5" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <video style="width:100%; height:300px !important" id="html5Video" class="" controls autoplay>
                        <source src="./assets/images/education-pro/Riju-Ghosh-Final-Video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>
    ...
    <!-- Modal3 -->
    <div class="modal fade" id="videoModal6" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="videoModalLabel">HTML5 Video</h5>
                ...
                <div class="modal-body p-0">
                    <video style="width:100%; height:300px !important" id="html5Video" class="" controls autoplay>
                        <source src="./assets/images/education-pro/Bhavesh-Kumar-Final-Video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>
    ...
    <!-- Modal3 -->
    <div class="modal fade" id="videoModal7" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="videoModalLabel">HTML5 Video</h5>
                ...
                <div class="modal-body p-0">
                    <video style="width:100%; height:300px !important" id="html5Video" class="" controls autoplay>
                        <source src="./assets/images/education-pro/Vrinda-Khemariya-Final-Video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>
    ...
    <!-- <section>
        <div class="carousel-wrapper">
            <h2>Success Stories from Our Learners
                Trusted by Thousands—See What Learners Are Saying Rated and Recommended by Future-Ready Professionals
            </h2>
            ...
            <div class="carousel-container">
                ...
                <div class="carousel-track-wrapper">
                    <div class="carousel-track">
                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal2">
                            <img src="https://img.youtube.com/vi/uFcbLftq-Wo/hqdefault.jpg" alt="User">
                            
                            <h4>Mohini-Singla</h4>
                        </div>
                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal3">
                            <img src="https://img.youtube.com/vi/rnu0vqtQxeA/hqdefault.jpg" alt="User">
                           
                            <h4>Anupam-Srivastav</h4>
                        </div>
                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal4">
                            <img src="https://img.youtube.com/vi/CE-SUNgKnqY/hqdefault.jpg" alt="User">
                           
                            <h4>Aditya-Giri</h4>
                        </div>
                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal5">
                            <img src="https://img.youtube.com/vi/sVdMAhh2pt8/hqdefault.jpg " alt="User">
                           
                            <h4>Riju Ghosh</h4>
                        </div>

                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal6">
                            <img src="https://img.youtube.com/vi/WfNxzyU2jJ0/hqdefault.jpg" alt="User">
                            
                            <h4>Bhavesh Kumar</h4>
                        </div>

                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal7">
                            <img src="https://img.youtube.com/vi/IFt6Y133b4U/hqdefault.jpg" alt="User">
            ...
            <div class="accordion" id="faqAccordion">
                    ...
                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            <ul>
                                ...
                                <li>Internship Opportunity for Professionals across various fields</li>
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq10" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            Top-performing learners will be shortlisted for internships with DPDP Consultants. The
    ...
    $(document).ready(function() {
        const $carousel = $('.carousel-track-wrapper');
        ...
        $('.nav1.left').click(function() {
            $carousel.animate({
                scrollLeft: $carousel.scrollLeft() - 300
            }, 400);
        });

        $('.nav1.right').click(function() {
            $carousel.animate({
                scrollLeft: $carousel.scrollLeft() + 300
            }, 400);
        });
        ...
        // Stop iframe video on modal hide (if used elsewhere)
        ...
        // Stop HTML5 video when modal is closed
        $('#videoModal2').on('hidden.bs.modal', function() {
            var video = $('#html5Video')[0];
            video.pause();
            video.currentTime = 0;
        });
    });
