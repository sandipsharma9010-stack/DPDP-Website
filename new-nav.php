...
<div tabindex="-1" aria-hidden="true" class="top-bar">
    <div class="right-top">
        <a target="_blank" href="http://tech.portal-uat.dpdpconsultants.com/dpgr_form?_gl=1"><i
            ...
            Principal Rights</a>
        <img style="width: 20px;" src="./assets/images/call-us.png" alt="Logo">
        <a href="tel:+18005711333">18005711333</a>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav mx-auto d-none d-lg-flex">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="compliance-tools.php" role="button">Compliance-Tools </a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="cookie-consent-management.php">Cookie Consent Management</a>
                        </li>
                    </ul>
                </li>
