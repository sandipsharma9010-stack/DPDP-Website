...
<head>
    ...
    <title>Digital Personal Data Protection consultants | Automated Compliance Tools</title>
    <meta name="description"
        content="Trusted DPDP Act compliance consultants with automated privacy compliance tools. Explore top compliance management tools for data protection under India�s Data Privacy Act.">
    <meta name="keywords"
...
<div class="mb-3">
Jaspal Singh is a seasoned technology leader with over two decades of experience in software engineering and digital transformation. Throughout his career, he has consistently demonstrated a strong commitment to solving complex technical problems, scaling enterprise applications, and aligning innovative technology solutions with strategic business objectives.
</div>
<div class="mb-3">
As Associate Director – Technology & Products, Jaspal specializes in leading cross-functional teams to architect and deliver end-to-end technology platforms. His areas of expertise include Cybersecurity, DevOps automation, CI/CD pipeline implementation, AWS cloud infrastructure, containerized deployments using Docker and Kubernetes, and building resilient Microservices-based architectures.
</div>
<div>
A strong advocate of Agile and Scrum practices, Jaspal ensures rapid and reliable product delivery while fostering a culture of continuous improvement and collaboration. He has played a pivotal role in modernizing legacy systems, enhancing product security, and driving cloud-native development for scalable SaaS platforms.
</div>
                        </p>
                    </div>
                </div>
    ...
    <div class="modal fade" id="profileModal5" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <img src="assets/images/out-team/akanksha.webp" alt="Founder/Principal: “Akansha Bhatt”"
                            class="profile-img">
                        <div class="name-container">
                            <h4 class="mt-2">Akansha Bhatt</h4>
                            <p class="text-muted">Senior Manager- Consulting & Growth</p>
                        </div>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold">About</h5>
                        <p class="modal-p">
                            Akansha is a seasoned data privacy, techno-legal consultant, and a corporate lawyer. She has
                            successfully handled various compliance activities and contract negotiations across
                            industries globally. Akansha has advised clients on data protection regulations such as
                            GDPR, CCPA, and DPDP, and has been instrumental in drafting policies and procedures. Her
                            expertise extends to performing and negotiating Data Processing Agreements, Non-disclosure
                            agreements, MSAs, DPIAs, DSARs, PIAs, DPIAs SCCs, and DPAs for organisations such as Wipro,
                            software, and Maersk. She has also conducted stakeholder training on privacy subject matter.
                            Her proficiency in handling Privacy compliances and risk management Compliances with global
                            companies set her apart.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold">About</h5>
                        <p class="modal-p">
                        Riju is a skilled expert in data privacy and protection, with knowledge of privacy governance and data privacy strategies.  He has professional experience of five years in digital transformation, emerging technologies, and tech risk and compliance management. He has successfully implemented data privacy processes for leading Indian companies, ensuring compliance with regulatory standards and industry best practices. Riju has completed multiple industry certifications such as ISO 27701 PIMS Lead Auditor and holds a B.Tech in Electronics and Communications Engineering from Karunya University, Coimbatore, and an MBA from Amity University, Noida. His career includes roles in Quality Assurance at Odessa Inc., Internet of Robotic Things implementation at Systemantics India, and Internet of Things DevOps at CWD Innovations. He has also interned with EY as a Tech Risk Consultant and has worked in HCLTech’s Business Acquisition Group. Riju's blend of technical expertise and business acumen has helped his clients achieve robust compliance while balancing business needs and ensuring process optimization, particularly in data privacy and digital transformation.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="profileModal77" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <img src="assets/images/out-team/sanjay_pic.jpg" alt="Sanjay Dinkar"
                            class="profile-img">
                        <div class="name-container">
                            <h4 class="mt-2">Sanjay Dinkar</h4>
                            <p class="text-muted">Director – Sales</p>
                        </div>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold">About</h5>
                        <p class="modal-p">
I am Sanjay Dinkar. I am a hard-core salesperson with a blend of Global Sales with strong technical background. An Engineering Graduate with 27 years of diversified business leadership skills (Industry specific) with global experience across Collaborative Cross Functional Business Management, Large Enterprise Account Management, People Management, Strategic Sales, Business Development and Consulting lead sales engagements in key verticals.
<br>
I have managed large business assignments, diverse teams and have worked in various markets and environments in India and the Southeast Asia, Middle East & Africa, Turkey, CIA countries.
<br>
Having worked with diverse clients across various segments, I have developed a fair understanding of strategies that drive business decisions across Construction, Oil & Gas, Marine, IT / ITES, GIS, Shipping, Automobile, Manufacturing, SCM – Logistics at Government, semi – government, public limited and private sectors.    
<br>
My strengths lies in the area of understanding clients business issues, networking with people using my technical background to formulate solutions to resolve these business issues and then articulating the value proposition of the solution to C Level executives to create compelling drivers for adoption of these solutions.
<br>
Leading by setting examples, I have a strong success rate in Sales across various domains, different geographies from Large to mid to small size organizations in Public Sector to Private to Government, Semi – Government organizations.
<br>
With strong understanding of sales – cycle, client networking, requirement understanding and creating requirements, i have successfully generated business throughout my sales roles. I even generated purchase orders, delivery and implementation, Invoicing, payments during Corona Pandemic in 2020 – 22.                    
</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-2">
                    <div class="profile-cards small-card">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#profileModal5">
                            ...
                            <div class="profile-infos">
                                <h6>Akansha Bhatt</h6>
                                <p>Senior Manager- Consulting & Growth</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-2">
                    <div class="profile-cards small-card">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#profileModal6">
                            <img src="assets/images/out-team/audrey1.jpg"
                                alt="Founder/Principal: “Audrey Saralin”">
                            <div class="profile-infos">
        ...
        <div class="container">
            ...
            <div class="custom-carousel-wrapper position-relative overflow-hidden">
                <div class="custom-carousel d-flex transition" id="customCarousel">
                    <img src="./assets/images/RICL.png" class="carousel-img" alt="T1" />
                    <img src="./assets/images/image36.png" class="carousel-img" alt="T2" />
                    <img src="./assets/images/image35.png" class="carousel-img" alt="T3" />
                    <img src="./assets/images/image42.png" class="carousel-img" alt="T4" />
                    <img src="./assets/images/image40.png" class="carousel-img" alt="T5" />
