                    ...
                    <div class="custom-carousel d-flex transition" id="customCarousel">
                        <div class="col-md-4">
                            <div class="custom-card carousel-img">
                                <div class="card-header c-header">
                                    <img src="./assets/images/blogs_46_thumbnail.jpg" alt="Card Image">
                        ...
                        <div class="col-md-4">
                            <div class="custom-card carousel-img">
                                <div class="card-header c-header">
                                    <img src="./assets/images/blogs_47_thumbnail.jpg" alt="Card Image">
                        ...
                        <div class="col-md-4">
                            <div class="custom-card carousel-img">
                                <div class="card-header c-header">
                                    <img src="./assets/images/blogs_41_thumbnail.jpg" alt="Card Image">
                        ...
                        <div class="col-md-4">
                            <div class="custom-card carousel-img">
                                <div class="card-header c-header">
                                    <img src="./assets/images/blogs_40_thumbnail.jpg" alt="Card Image">
                        ...
                        <div class="col-md-4">
                            <div class="custom-card carousel-img">
                                <div class="card-header c-header">
                                    <img src="./assets/images/blogs_39_thumbnail.jpg" alt="Card Image">
