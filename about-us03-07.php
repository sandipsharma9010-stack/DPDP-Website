    ...
    <div class="modal fade" id="profileModal77" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <img src="assets/images/out-team/sushant.jpg" alt="Sushant Aggarwal" class="profile-img">
                        <div class="name-container">
                            <h4 class="mt-2">Sushant Aggarwal</h4>
                            <p class="text-muted">Enterprise Sales Manager</p>
                        </div>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold">About</h5>
                        <p class="modal-p">Enterprise Sales Manager | Data Privacy Advocate | Driving DPDP Act 2023
                            Compliance
                            With over 5 years of experience across enterprise sales, business development, and solution
                            consulting, I specialize in helping organizations navigate complex data privacy
                            regulations—especially India’s DPDP Act 2023. At DPDP Consultants, I work closely with CIOs
                            and CISOs to deliver tailored compliance solutions through deep domain knowledge, effective
                            stakeholder engagement, and solution-driven proposals. My background spans industries
                            including manufacturing, energy, and tech—enabling me to translate regulatory needs into
                ...
                <div class="col-sm-2">
                    <div class="profile-cards small-card">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#profileModal77">
                            <img src="assets/images/out-team/sushant.jpg" alt="Sanjay Dinkar">
                            <div class="profile-infos">
                                <h6>Sushant Aggarwal</h6>
