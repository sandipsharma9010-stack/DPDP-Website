...
<head>
    ...
    <title>DPDP Consultants | Simplify DPDPA Compliance with End-to-End Privacy Tools adhering to DPDPA Law</title>
    <meta name="description"
        content="Streamline your DPDPA compliance journey with our expert consulting and advanced Privacy tools.Explore consent management, impact assessments, grievance redressal, and more to safeguard sensitive data, enhance governance, and mitigate privacy risks effectively.">
    ...
    @media (max-width: 768px) {
        .compliance-item {
            width: 50%;
            /* Ensures two items per row on mobile too */
            padding: 10px 0;
        }
...
<body>
        ...
        <div class="container hero-section text-white">
            <div class="row">
                <div class="col-md-6 order-md-1 text-center text-md-start">
                    ...
                    <p>Tailored Data Privacy compliance solutions to empower organizations in understanding,
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="row text-center">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-6 compliance-item">
                            <img src="./assets/SVG-Icons/svg_381153.svg" alt="Icon">
                            <span class="we-font d-block">100+</span>
                            <p>Privacy Compliance Globally</p>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-6 compliance-item">
                            <img src="./assets/SVG-Icons/svg_453458.svg" alt="Icon">
                            <span class="we-font d-block">500+</span>
                            <p>Total Assessments</p>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-6 compliance-item">
                            <img src="./assets/SVG-Icons/svg_391889.svg" alt="Icon">
                            <span class="we-font d-block">50+</span>
                            <p>Expert Privacy Advisors</p>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-6 compliance-item">
                            <img src="./assets/SVG-Icons/svg_372123.svg" alt="Icon">
                            <span class="we-font d-block">100%</span>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="our-service-card">
                        <div class="left-content">
                            <span class="our-service-icon"><img src="assets/images/dpdpa-act.png"></span>
                    ...
                    <div class="our-service-card">
                        <!-- Default Open -->
                        <div class="left-content">
                            <span class="our-service-icon"><img src="./assets/images/compliance-assistance.png"></span>
                            <div class="content-wrapper">
                    ...
                    <div class="our-service-card">
                        <div class="left-content">
                            <span class="our-service-icon"><img
                                    src="./assets/images/data-protection-officer.png"></span>
                            <div class="content-wrapper">
                    ...
                    <div class="our-service-card">
                        <div class="left-content">
                            <span class="our-service-icon"><img src="./assets/images/dpdpa-act-training.png"></span>
                            <div class="content-wrapper">
                    ...
                    <div class="our-service-card">
                        <div class="left-content">
                            <span class="our-service-icon"><img src="./assets/images/contract-review-dpdp.png"></span>
                            <div class="content-wrapper">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="section-box-one-step">
                        <img src="./assets/images/one-step1.png" class="icon-one-step" alt="icon">
                        <div>
                    ...
                    <div class="section-box-one-step">
                        <img src="./assets/images/one-step2.png" class="icon-one-step" alt="icon">
                        <div>
                    ...
                    <div class="section-box-one-step">
                        <img src="./assets/images/one-step3.png" class="icon-one-step" alt="icon">
                        <div>
                    ...
                    <div class="section-box-one-step">
                        <img src="./assets/images/one-step4.png" class="icon-one-step" alt="icon">
                    ...
                    <div class="section-box-one-step">
                        <img src="./assets/images/one-step5.png" class="icon-one-step" alt="icon">
                        <div>
            ...
            <div class="row g-4 work-row.g-4">
                <div class="col-md-4 work-col">
                    <div class="card-work">
                        ...
                        <p>We evaluate privacy practices across your organization, documenting processes, data flows,
                ...
                <div class="col-md-4 work-col">
                    <div class="card-work">
                        ...
                        <h5 class="fw-bold">Policy Development</h5>
                        <p>We develop comprehensive privacy policies and procedures tailored to organization’s specific
                ...
                <div class="col-md-4 work-col">
                    <div class="card-work">
                        ...
                        <h5 class="fw-bold">Compliance Tools Implementation</h5>
                        <p>We address organizational obligations including data governance and compliance verification
                ...
                <div class="col-md-4 work-col">
                    <div class="card-work">
                        ...
                        <h5 class="fw-bold">Monitoring and Auditing</h5>
                        <p>We establish monitoring protocols, track remediation progress, and conduct comprehensive
                ...
                <div class="col-md-4 work-col">
                    <div class="card-work">
                        ...
                        <h5 class="fw-bold">Reporting and Documentation</h5>
                        <p>We maintain detailed documentation of all compliance activities, providing regular reports on
                ...
                <div class="col-md-4 work-col">
                    <div class="card-work">
                        ...
                        <h5 class="fw-bold">Ongoing Support and Updates</h5>
                        <p>We provide continuous support to ensure your organization remains compliant with evolving
    ...
    <section class="home-why mt-5">
        <div class="container why-spa">
            <div class="text-Why text-center mb-5">
                <h6>Why Us?</h6>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="card-custom">
                        <div class="icon-box">
                            <img src="./assets/images/proprietary.png" alt="Proprietary Tools">
                        </div>
                        <div class="contents">
                ...
                <div class="col-sm-4">
                    <div class="card-custom">
                        <div class="icon-box">
                            <img src="./assets/images/customized.png" alt="Customized Solutions">
                        </div>
                        <div class="contents">
                ...
                <div class="col-sm-4">
                    <div class="card-custom">
                        <div class="icon-box">
                            <img src="./assets/images/efficient.png" alt="Efficient Process">
                        </div>
                        <div class="contents">
                ...
                <div class="col-sm-4">
                    <div class="card-custom">
                        <div class="icon-box">
                            <img src="./assets/images/end-to-end.png" alt="End-to-End Support">
                        </div>
                        <div class="contents">
                ...
                <div class="col-sm-4">
                    <div class="card-custom">
                        <div class="icon-box">
                            <img src="./assets/images/proven.png" alt="Proven Track Record">
                        </div>
                        <div class="contents">
        ...
        <div class="container text-center">
            <div class="row align-items-center">
                <div class="col-md-8 map-container">
                    <img src="./assets/images/Map.jpg" alt="India Map" class="img-fluid">

                </div>
                <div class="col-md-4">
                    <div class="make-india">
                        <img src="./assets/images/make-in-india.png" alt="" class="">
                    ...
                    <div class="contents text-end ">
                        ...
                        <p>Your trusted partner in data protection, ensuring<br> privacy & security across every corner.
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="custom-card">
                        ...
                        <div class="card-body c-body">
                            <h6><a href="https://www.dpdpconsultants.com/new_2025/blog.php?id=29&title=">DPDP Act vs ISO
                ...
                <div class="col-md-4">
                    <div class="custom-card">
                        ...
                        <div class="card-body c-body">
                            <h6><a href="https://www.dpdpconsultants.com/new_2025/blog.php?id=24&title"> How will the
                ...
                <div class="col-md-4">
                    <div class="custom-card">
                        ...
                        <div class="card-body c-body">
                            <h6><a href="https://www.dpdpconsultants.com/new_2025/blog.php?id=28&title">Copy of Data
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="text-Testim">
                        ...
                        <h2 class="testimonials-head">Voices of<br> <span class="text-Success">Success,
                ...
                <div class="col-md-4 col-lg-4 g-3">
                    <div class="testimonial-card d-flex flex-column flex-md-row align-items-center align-items-md-start text-center text-md-start p-3"
                        ...
                        <div class="ms-3">
                            <h5>Mahalakshmi.PG</h5>
                            <span class="company">Carl Zeiss India Pvt. Ltd.</span>
                            <p class="text-muted">General Counsel</p>
                            <span class="stars">★★★★★</span>
                            <p class="mt-2">"We engaged DPDP Consultants to assist us in implementing compliance with
                    ...
                    <div id="newsletterCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="https://www.dpdpconsultants.com/new_2025/newsletter.php?id=11&title"><img
                                        src="./assets/images/newsletters_11_thumbnail.jpg" class="d-block"
                                        alt="Slide 1"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="https://www.dpdpconsultants.com/new_2025/newsletter.php?id=12&title"><img
                                        src="./assets/images/newsletters_12_thumbnail.jpg" class="d-block"
                                        alt="Slide 2"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="https://www.dpdpconsultants.com/new_2025/newsletter.php?id=14&title"><img
                                        src="./assets/images/newsletters_14_thumbnail.jpg" class="d-block"
                                        alt="Slide 3"></a>
                            </div>
                        </div>
    ...
    const contents = [
        ...
        `<div class="card-custom-tools">
                    ...
                    Your browser does not support the video tag.
                                ...
                                <div class="benefits-container mt-3">
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/159.png" alt="Benefit 1">
                                        <p>Effortless Grievance Management for Data Fiduciaries</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/160.png" alt="Benefit 2">
                                        <p>Seamless Grievance Redressal Mechanism</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/161.png" alt="Benefit 3">
                                        <p>Timely Response with Automated Acknowledgement</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/162.png" alt="Benefit 4">
                                        <p>Advanced Rights and Grievance Tracking & Management</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/163.png" alt="Benefit 5">
        ...
        `<div class="card-custom-tools">
                    ...
                    Your browser does not support the video tag.
                                ...
                                <div class="benefits-container mt-3">
                                    <div class="benefit">
                                        <img src="./assets/images/DPAP-Icons/191.png" alt="Benefit 1">
                                        <p>Self-Paced Learning</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/DPAP-Icons/192.png" alt="Benefit 2">
                                        <p>End-of-Module Assessments</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/DPAP-Icons/193.png" alt="Benefit 3">
                                        <p>Scoring and Pass/Fail Criteria</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/DPAP-Icons/194.png" alt="Benefit 4">
                                        <p>Compliance Tracking and Reporting</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/DPAP-Icons/195.png" alt="Benefit 5">
        ...
        `<div class="card-custom-tools">
                    ...
                    Your browser does not support the video tag.
                                ...
                                <div class="benefits-container mt-3">
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/169.png" alt="Benefit 1">
                                        <p>Streamlined Workflow and Efficiency</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/170.png" alt="Benefit 2">
                                        <p>Risk Assessment & Mitigation</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/171.png" alt="Benefit 3">
                                        <p>Risks tracking and management</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/172.png" alt="Benefit 4">
                                        <p>Comprehensive Reporting & Audit Trail</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/173.png" alt="Benefit 5">
        ...
        `<div class="card-custom-tools">
                    ...
                    Your browser does not support the video tag.
                                ...
                                <div class="benefits-container mt-3">
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/179.png" alt="Benefit 1">
                                        <p>Third Party Due Diligence</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/180.png" alt="Benefit 2">
                                        <p>Configurable Assessments</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/181.png" alt="Benefit 3">
                                        <p>Third Party Risk Evaluation</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/182.png" alt="Benefit 4">
                                        <p>Integrated Data Management Across Third parties</p>
                                    </div>
                                    <div class="benefit">
                                        <img src="./assets/images/tools-icon/183.png" alt="Benefit 5">
