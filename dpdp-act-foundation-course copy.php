  ...
  <div class="container">
    ...
    <div class="custom-carousel-wrapper position-relative overflow-hidden">
      <div class="custom-carousel d-flex transition" id="customCarousel">
        <img src="./assets/images/education-pro/T1.png" class="carousel-img" alt="T1" />
        <img src="./assets/images/education-pro/T2.png" class="carousel-img" alt="T2" />
        <img src="./assets/images/education-pro/T3.png" class="carousel-img" alt="T3" />
        <img src="./assets/images/education-pro/T4.png" class="carousel-img" alt="T4" />
        <img src="./assets/images/education-pro/T5.png" class="carousel-img" alt="T5" />
        <img src="./assets/images/education-pro/T6.png" class="carousel-img" alt="T6" />
        <img src="./assets/images/education-pro/T7.png" class="carousel-img" alt="T7" />
        <img src="./assets/images/education-pro/T8.png" class="carousel-img" alt="T8" />
        <img src="./assets/images/education-pro/T9.png" class="carousel-img" alt="T9" />
        <img src="./assets/images/education-pro/T10.png" class="carousel-img" alt="T9" />
        <img src="./assets/images/education-pro/T11.png" class="carousel-img" alt="T9" />
        <img src="./assets/images/education-pro/T12.png" class="carousel-img" alt="T9" />
      </div>
    ...
    <section>
        ...
        <p>Testimonails</p>
            <h3 class="section-highlight">Trusted Excellence: Documented Professional Growth and<br> Achievement Stories
                ...
                <div class="carousel-track-wrapper">
                    <div class="carousel-track">
                        <div class="testimonial-card">
                            <video id="html5Video" class="w-100" controls autoplay>
                                <source src="assets/images/education-pro/Aditya-Giri.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <h4>Aditya Giri</h4>
                        ...
                        <div class="testimonial-card">
                            <video id="html5Video" class="w-100" controls autoplay>
                                <source src="assets/images/education-pro/Anupam-Srivastav-Final-Video.mp4"
                                    type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        ...
                        <div class="testimonial-card">
                            ...
                            <h4>Riju Ghosh</h4>
                            <p class="fw-bold">Senior Data Protection Consultants</p>
                            <p>DPDP Consultants</p>
                        </div>
                        <div class="testimonial-card">
                            <video id="html5Video" class="w-100" controls autoplay>
                                <source src="assets/images/education-pro/Bhavesh-Kumar-Final-Video.mp4"
                                    type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <h4>Bhavesh Kumar</h4>
                        ...
                        <div class="testimonial-card">
                            <video id="html5Video" class="w-100" controls autoplay>
                                <source src="assets/images/education-pro/Mohini-Singla-Final-Video.mp4"
                                    type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <h4>Mohini-Singla</h4>
                        ...
                        <div class="testimonial-card">
                            <video id="html5Video" class="w-100" controls autoplay>
                                <source src="assets/images/education-pro/Vrinda-Khemariya-Final-Video.mp4"
                                    type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
    ...
    $(document).ready(function() {
        const $carouselWrapper = $('.carousel-track-wrapper');
        const $carouselTrack = $('.carousel-track');
        const scrollAmount = 1;
        let autoScroll;

        // Step 1: Duplicate the testimonial cards
        const cards = $carouselTrack.children().clone();
        $carouselTrack.append(cards);

        function startAutoScroll() {
            autoScroll = setInterval(() => {
                $carouselWrapper.scrollLeft($carouselWrapper.scrollLeft() + scrollAmount);

                // Step 2: Reset scroll when halfway reached
                if ($carouselWrapper.scrollLeft() >= $carouselTrack[0].scrollWidth / 2) {
        ...
        $('.nav1.left').click(function() {
            $carouselWrapper.animate({
                scrollLeft: $carouselWrapper.scrollLeft() - 300
            }, 400);
        });
        ...
        // ✅ Fix: use event delegation to always catch click events
        $carouselTrack.on('click', '.testimonial-card', function() {
            stopAutoScroll();
        });
