...
<head>
    ...
    <title>DPDP Act Compliance News & Updates</title>
    <meta name="description"
        content="Follow India’s top privacy stories including breaches, penalties and enforcement linked to the DPDP Act Compliance.">
    <meta name="keywords"
        content="DPDP Act news, data privacy updates, DPDPA compliance developments, privacy regulation news, industry compliance trends, regulatory updates, data protection industry news">
 ...
 <link rel="icon" href="assets/images/fav-icon-logo.png" type="image/webp">
    ...
    <link rel="canonical" href="https://www.dpdpconsultants.com/inthenews.php">
    <style>
    .blog {
        text-align: center;
        color: white;
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="news-card">
                    ...
                    <div>
                        <h5>
                            <a target="_blank" href="<?php echo $dbrec['linkurl']; ?>">
                                <?php echo $dbrec['rectitle']; ?>
                            </a>
                        </h5>

                        <div class="in-the-news">
                            <p><strong>Publisher: </strong><?php echo $dbrec['recpub']; ?></p>
                            <p><strong>Published: </strong><?php echo $dbrec['recdate']; ?></p>
                        </div>
                        <div class="btn btn-primary w-100 p-0">summary</div>
                        <p class="py-2"><?php echo $dbrec['recdesc']; ?></p>
                    </div>
                </div>
            </div>
            <!--
                    <div class="col-sm-3">
                        <div class="header-news">Similar Topics</div>
                        <div class="card-news">
                            <div class="card-body">
                                <h5 class="card-title-news">DPDP Act, draft Rules threaten privacy, autonomy of PwDs,
                                    infantilises them, argue activists</h5>
                                <p class="card-text-news">Policy think tanks, experts, and activists in the disability
                                    rights sector are trying to build a coalition to amend or drop key consent clause of
                                    DPDP Act that clubs children with PwDs.</p>
                                    <div class="d-flex justify-content-end">
                                    <p class="publisher">Publisher: Hindustan Times</p>
                                </div>
                            </div>
                        </div>
                    </div>
