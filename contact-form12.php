            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                     ...
                     <div class="consent-preferences mb-4">
        <h5 class="fw-bold">Consent Preferences</h5>
        <p class="text-muted">
            Please select the processing activities you consent to:
        </p>
        

        <!-- Email Campaigns (Required & Checked) -->
<div class="consent-card required position-relative">
    
    <small class="retention-text">Retention Period: 12 months</small>
    ...
    <p class="mb-0 text-muted small">
        Data collected for email marketing campaigns and promotions
    </p>
</div>


<!-- Social Media Marketing -->
<div class="consent-card mt-3 position-relative">
    
    <small class="retention-text">Retention Period: 18 months</small>
    ...
    <p class="mb-0 text-muted small">
        Information used for social media advertising and engagement
    </p>
</div>
...
//     document.querySelectorAll('.consent-card input[type="checkbox"]').forEach(function(checkbox) {
