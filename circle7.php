<section>
    <div class="container" style="padding:85px 40px;">
        <div class="text-center unleashs">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="circle-img">
                    ...
                    <!-- Icons -->
                    <div class="circle1">
                        <img src="assets/images/224.png" class="icon-btns" data-id="1">
                    </div>
                    <div class="circle2">
                        <img src="assets/images/363.png" class="icon-btns" data-id="2" >
                    </div>
                    <div class="circle3">
                        <img src="assets/images/362.png" class="icon-btns" data-id="3">
                    </div>
                    <div class="circle4">
                        <img src="assets/images/364.png" class="icon-btns" data-id="4">
                    </div>
                    <div class="circle5">
                        <img src="assets/images/229.png" class="icon-btns" data-id="5">
                    </div>
                    <div class="circle6">
                        <img src="assets/images/228.png" class="icon-btns" data-id="6">
                    </div>
                    <div class="circle7">
                        <img src="assets/images/230.png" class="icon-btns" data-id="7">
                    </div>
                    <div class="circle8">
                        <img src="assets/images/231.png" class="icon-btns" data-id="8">
                    </div>
                    <div class="circle9">
                        <img src="assets/images/224.1.png" class="icon-btns" data-id="9">
                    </div>
                    <div class="circle10">
                        <img src="assets/images/232.png" class="icon-btns" data-id="10">
                    </div>
                    <div class="circle11">
                        <img src="assets/images/233.1.png" class="icon-btns" data-id="11">
                    </div>
                    <div class="circle12">
                        <img src="assets/images/DPCM.1.png" data-id="12" class="icon-btns dpgr-icon">
                        <div class="icons-dpcm">DPCM</div>
                    </div>
                    <div class="circle13 icon-wrapper">
                        <img src="assets/images/DPGR.1.png" data-id="13" class="icon-btns dpgr-icon">
                        <div class="icon-label">DPGR</div>
                    </div>
                    <div class="circle14">
                        <img src="assets/images/DPAP.1.png" class="icon-btns dpgr-icon" data-id="14">
                        <div class="icons-dpap">DPAP</div>
                    </div>
                    <div class="circle15">
                        <img src="assets/images/DPIA.1.png" class="icon-btns dpgr-icon" data-id="15">
                        <div class="icons-dpia">DPIA</div>
                    </div>
                    <div class="circle16">
                        <img src="assets/images/DPTPA.1.png" class="icon-btns dpgr-icon" data-id="16">
                        <div class="icons-dptpa">DPTPA</div>
                    </div>
                ...
                <div id="content-1" class="icon-content active">
                    <div class="dpa-card">
                        <div class="badge-icon">
                            <img src="https://cdn-icons-png.flaticon.com/512/10122/10122156.png" alt="Icon">
                        </div>
