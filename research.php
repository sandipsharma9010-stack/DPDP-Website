...
<head>
    ...
    <title>DPDP Act Compliance Research Reports</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.3/css/bootstrap.min.css">
    <meta name="description"
        content="Explore detailed research reports on data privacy, DPDPA compliance, and emerging industry practices to strengthen your data protection strategy.">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="text-center mt-4">
                    <a target="_blank" href="contact.php?act=research&proceed=<?php echo base64_encode($dbrec['recfile']); ?>"
