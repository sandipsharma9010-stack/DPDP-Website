...
<?php $act = $_REQUEST["act"] = 'course'; include_once('device-type.php'); ?>
    <?php $act = $_REQUEST["act"] = 'course'; include_once('contact-getapi.php'); ?>
...
<?php if( ($_POST) && ($otp) && ($show !== 'thanks') ) { ?>
    ...
    <h4 class="fw-bold mb-2 thanks-heading">Thanks for registering!</h4>
                    <p class="">Your spot is reserved — just hit Pay Now to access everything we've prepared
                        for you.</p>
