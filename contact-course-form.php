...
<?php if( (!$otp) && ($show !== 'thanks') ) { ?>
                ...
                <form xclass="needs-validation" action="#divotp" method="post" id="mainForm" xnovalidate>
                        ...
                        <input type="text" name="gst_address" value="<?php echo $gst_address;?>" style="display:none"  />
...
<style> .gst-fields { display: none; margin-top: 10px;} </style>

<div class="pt-3"><label> <input type="checkbox" id="gstCheckbox"> Enter GST details </label></div>
    ...
    <div class="container">
        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control input-shadow" placeholder="GST name" name="gst_name" value="<?php echo $gst_number;?>" />
                            </div>
                        

                            <div class="col-md-6">
                                <label class="form-label">Address</label>
                                <input type="text" class="form-control input-shadow" placeholder="GST address" name="gst_street" value="<?php echo $gst_street;?>" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Street</label>
                                <input type="text" class="form-control input-shadow" placeholder="GST street" name="gst_street2" value="<?php echo $gst_street2;?>" />
                            </div>
                           

                            <div class="col-md-6">
                                <label class="form-label">City</label>
                                <input type="text" class="form-control input-shadow" placeholder="GST city" name="gst_city" value="<?php echo $gst_city;?>" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Zip</label>
                                <input type="text" class="form-control input-shadow" placeholder="GST zip" name="gst_zip" value="<?php echo $gst_zip;?>" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">State</label>
                                <input type="text" class="form-control input-shadow" placeholder="GST state" name="gst_state" value="<?php echo $gst_state;?>" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Country</label>
                                <input type="text" class="form-control input-shadow" placeholder="GST country" name="gst_country" value="<?php echo $gst_country;?>" />
                            </div>
