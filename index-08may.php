    ...
    <section class="news-section sec-pad">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item"><img src="./assets/images/client-logo/motors_xcelion.png"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>


                 <div class="item"><img src="./assets/images/client-logo/TICM_Logo.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>
                 <div class="item"><img src="./assets/images/client-logo/Signature_Global_Logo.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>

                <div class="item"><img src="./assets/images/client-logo/Relaxo_Logo.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>

                 <div class="item"><img src="./assets/images/client-logo/Nuziveedu_Seeds_Logo.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>

                <div class="item"><img src="./assets/images/client-logo/KEI_Cables_Logo.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>

                <div class="item"><img src="./assets/images/client-logo/Kanpur_Plastic_Pack_Limited.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>

                <div class="item"><img src="./assets/images/client-logo/Ajanta_Pharma_Logo.svg"
                        alt="Tata Motors Xcelion Logo – Data Protection Compliance for the automotive manufacturer Tata Motors Xcelion.">
                </div>
            </div>
        </div>
                    ...
                    <div class="testimonial-card d-flex flex-column flex-md-row align-items-center align-items-md-start text-center text-md-start p-3"
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mt-2 test-para">“We are pleased to acknowledge the valuable support provided by
                                <strong>PRIVACYIUM TECH PRIVATE LIMITED – DPDP Consultants</strong> during Tata Motors Xcelion’s Digital
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="testimonialModal5" tabindex="-1" aria-labelledby="testimonialModalLabel"
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <img src="./assets/images/client-logo/motors_xcelion.png" alt="tata motors xcelion" class="img-fluid mb-3">
                                <h5>Ajay Wadhwa</h5>
                                <span class="company">Tata Motors Xcelion</span>
                                <p class="text-muted">Chief Executive Officer</p>
                                <span class="stars">★★★★★</span>
                                <p class="mt-2">“We are pleased to acknowledge the valuable support provided by
                                    <strong>PRIVACYIUM TECH PRIVATE LIMITED – DPDP Consultants</strong> during Tata Motors Xcelion’s
                                    <strong>Digital Personal Data Protection Act (DPDPA) assessment.</strong> Their structured approach
