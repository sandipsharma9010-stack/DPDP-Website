        ...
        <div class="container hero-section text-white">
            <div class="row">
                <div class="col-md-6 order-md-1 text-center text-md-start">
                    ...
                    <div
                        class="mt-4 d-flex flex-column flex-sm-row justify-content-center justify-content-md-start home-btn-m">
    ...
    <section class="news-section sec-pad">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item"><img src="./assets/images/client-logo/ashok-leyland-vector-logo.png"
                ...
                <div class="item"><img src="./assets/images/client-logo/sk-finance.png"
                ...
                <div class="col-md-4 col-lg-4 my-3">
                    <div class="testimonial-card d-flex flex-column flex-md-row align-items-center align-items-md-start text-center text-md-start p-3"
                        ...
                        <div class="ms-3">
                            ...
                            <span class="stars">★★★★★</span>
                            <p class="mt-2">"On our recent collaboration with your organisation for our compliance
                                journey under the Digital Personal Data Protection (DPDP) Act gave me, my team &
                                associated business functions a great experience.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                ...
                                <p class="mt-2">"On our recent collaboration with your organisation for our compliance
                                    journey under the Digital Personal Data Protection (DPDP) Act gave me, my team &
                                    associated business functions a great experience. Right from the beginning, your
                                    team showed great professionalism and a strong understanding of both the DPDP rules
                                    aligned with our business processes. The suggestions given were not just theory –
                                    they were practical and fit well into our current processes, which will help us in
                                    the long run. What really impressed us was your team's organised and step-by-step
                                    approach. Throughout the entire process, they provided full support and were always
                                    available when needed. They paid close attention to every detail and made sure that
                                    important tasks like the Privacy Impact Assessments for our applications were
                                    completed and submitted on time. Because of this, we were able to stay compliant
                                    without affecting our day-to-day work. We have complete confidence in the expertise
                                    of DPDP Consultants Team and would highly recommend them to any organisation seeking
                                    a reliable partner in Data Privacy and regulatory compliance. The session you
                                    personally conducted for our Leadership team was very well received and appreciated
                                    by everyone. It really helped in giving a clear and easy-to-understand overview of
                                    the DPDP Act, and was a great learning experience for all.
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="newsletterCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="testimonial-card d-flex flex-column flex-md-row align-items-center align-items-md-start text-center text-md-start"
                                    data-bs-toggle="modal" data-bs-target="#testimonialModal" data-bs-toggle="modal"
                                    data-bs-target="#testimonialModal">
                                    <!-- <img class="img-fluid" src="./assets/images/client-logo/zeiss_logo.png" alt="User"> -->
                                    <div class="ms-3">
                                        ...
                                        <p class="text-muted">General Counsel</p>
                                        <span class="stars">★★★★★</span>
                                        <p class="mt-2">"We engaged DPDP Consultants to assist us in implementing
                                            compliance with
                                            the Digital Personal Data Protection (DPDP) Act for our Indian entity, and
                                            the
                                            experience has been exceptional.
                                        </p>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-card d-flex flex-column flex-md-row align-items-center align-items-md-start text-center text-md-start p-3"
                                    ...
                                    <div class="ms-3 text-muted">
                                        ...
                                        <p class="text-muted">Director – Research and Client Services</p>
                                        <span class="stars">★★★★★</span>
                                        <p class="mt-2">"Working with DPDP Consultants has significantly improved our
                                            digital
                                            privacy compliance. Their deep expertise in data privacy laws like DPDP,
                                            GDPR, and<br> CCPA
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-card d-flex flex-column flex-md-row align-items-center align-items-md-start text-center text-md-start p-3"
                                    ...
                                    <div class="ms-3 text-muted">
                                        ...
                                        <p class="text-muted">Vice President – IT & CyberSecurity</p>
                                        <span class="stars">★★★★★</span>
                                        <p class="mt-2">"On our recent collaboration with your organisation for our
                                            compliance
                                            journey under the Digital Personal Data Protection (DPDP) Act gave me, my
                                            team &
                                            associated business functions a great experience.
                                        </p>
                                    </div>
                ...
                <div class="col-sm-5">
                    <div class="text-Testim">
                        <h5 class="text-monials">Testimonials</h5>
                        <h2 class="testimonials-head text-muted">Voices of<br> <span class="text-Success">Success,
                                Stories</span><br> that Inspire</h2>
                    </div>
                </div>
