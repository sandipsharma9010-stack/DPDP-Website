            ...
            <div class="row">
                ...
                <div class="col-md-6 order-md-2 text-center position-relative">
                    ...
                    <iframe style="width:100%; height: 90%;" id="videoFrame"
                        src="https://www.youtube.com/embed/kBJYCQ-49sM" title="YouTube video"
            ...
            <div class="carousel-container">
                ...
                <div class="carousel-track-wrapper">
                    <div class="carousel-track">
                        <div class="testimonial-card" data-bs-toggle="modal" data-bs-target="#videoModal1">
                            <img src="https://via.placeholder.com/80" alt="User">
                            <p>"Amazing service! Quick and professional."</p>
                            <h4>- Alice Green</h4>
                        </div>
                        <div class="testimonial-card">
                            <img src="https://via.placeholder.com/80" alt="User">
                            <p>"They really care about the customer experience."</p>
                            <h4>- Bob White</h4>
                        </div>
                        <div class="testimonial-card">
                            <img src="https://via.placeholder.com/80" alt="User">
                        ...
                        <div class="testimonial-card">
                            <img src="https://via.placeholder.com/80" alt="User">
                            <p>"I would absolutely recommend them to others."</p>
                            <h4>- Tom Red</h4>
                        </div>
                    </div>
                </div>
