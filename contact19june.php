...
<head>
    ...
    <style>
        ...
        /* Wrapper for API content */
        .language-content {
            overflow-x: auto;
            -webkit-overflow-scrolling: touch;
        }

        /* Force all API tables to be responsive */
        ...
        /* Remove fixed widths from API */
        .language-content table,
        .language-content table td,
        .language-content table th {
            min-width: 120px;
        }
...
<body>
    ...
    <section class="blog" style="background-color: #02092c;">
        ...
        <?php if ($act == 'Partnerwithus') { ?>
            <div class="container hero-contact">
                ...
                <p>Fill out the form to collaborate with DPDP Consultants on data protection compliance initiatives. Partner
                    with us to help clients meet regulatory requirements, strengthen privacy frameworks, and ensure robust
        ...
        <?php } elseif ($act == 'schedule') { ?>
            <div class="container hero-contact">
                ...
                <p>Schedule a call with DPDP Consultants to discuss your organization’s DPDP compliance needs. Our experts
                    will guide you through requirements, clarify obligations, and help you plan a clear path to achieving
                    and maintaining data protection compliance.
                </p>
            </div>
    ...
    <?php include_once('contact-form12.php'); ?>
